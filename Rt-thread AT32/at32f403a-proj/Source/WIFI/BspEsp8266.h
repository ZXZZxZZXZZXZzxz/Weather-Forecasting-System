...
/********************************使用PIN设备*****************************************************/
#define macESP8266_RST_PIN    GET_PIN(A, 0)

#define macESP8266_CH_PD_PIN    GET_PIN(A, 1)
/******************************** ESP8266 连接引脚定义 ***********************************/
...
//#define      macESP8266_CH_PD_PIN                             GPIO_Pins_1
...
//#define      macESP8266_RST_PIN                               GPIO_Pins_0
...
#define      macESP8266_USART_TX_PIN                          GPIO_Pins_2
#define      macESP8266_USART_RX_PORT                         GPIOA
#define      macESP8266_USART_RX_PIN                          GPIO_Pins_3
...
#define     macESP8266_CH_ENABLE()                 rt_pin_write ( macESP8266_CH_PD_PIN, PIN_HIGH )
#define     macESP8266_CH_DISABLE()                rt_pin_write ( macESP8266_CH_PD_PIN, PIN_LOW )

#define     macESP8266_RST_HIGH_LEVEL()            rt_pin_write ( macESP8266_RST_PIN, PIN_HIGH )
#define     macESP8266_RST_LOW_LEVEL()             rt_pin_write ( macESP8266_RST_PIN, PIN_LOW )
...
extern bool WIFI_connect_Sign;//WIFI连接状态标志
#endif
